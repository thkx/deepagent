...
func NewPrometheusCollector(registry *PrometheusRegistry) MetricsCollector {
	if registry == nil {
...
// Metrics returns underlying *prometheus.Registry for external exposition.
func (p *prometheusCollector) Metrics() any {
	return p.registry
}
